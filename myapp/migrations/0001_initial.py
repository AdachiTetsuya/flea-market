# Generated by Django 3.2 on 2021-12-30 01:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('novel', '文学/小説'), ('society', '人文/社会'), ('culture', 'ノンフィクション/教養'), ('travel', '地図/旅行ガイド'), ('economy', 'ビジネス/経済'), ('health', '健康/医学'), ('IT', 'コンピュータ/IT'), ('hobby', '趣味/スポーツ/実用'), ('life', '住まい/暮らし/子育て'), ('art', 'アート/エンタメ'), ('foreign', '洋書'), ('picture', '絵本'), ('study', '参考書'), ('other', 'その他')], max_length=10)),
